...
// ✅ SỬA LỖI 1: Import instance (chữ 'p' thường), không import Class
...
export class DesignService {
  constructor() {
    ...
    // ✅ SỬA LỖI 2: Khởi tạo productRepo từ instance đã import
  ...
  async createTemplate(printerId, body, files) {
    ...
    // (Bỏ try/catch vì middleware parseJsonFields sẽ làm việc này)
    ...
    // ✅ SỬA LỖI 3: Kích hoạt (bỏ comment) logic validation
