...
router.post(
  "/conversations/group",
  protect,
  uploadMixed.single("avatar"),
  handleUploadError,
  convController.createGroupConversation
);
router.patch(
...
router.post(
  ...
  protect,
  convController.createOrGetPrinterConversation
);
router.post(
  "/conversations/peer/:userId",
  protect,
  convController.createOrGetPeerConversation
);
router.get(
...
router.post(
  ...
  protect,
  convController.markAllConversationsAsRead
);
