// apps/customer-frontend/src/features/organization/components/OrderThreadDialog.tsx
/**
 * Order Thread Dialog - Reusable chat dialog for order-level discussions
 * Wraps delivery thread functionality for order context
 */
...
interface OrderThreadDialogProps {
  orderId: string;
  orderNumber: string;
  open: boolean;
...
export function OrderThreadDialog({
  orderId,
  orderNumber,
  open,
  onOpenChange,
}: OrderThreadDialogProps) {
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4">
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center h-full text-gray-400">
              ...
              <p className="text-sm mt-1">Bắt đầu cuộc trò chuyện ngay!</p>
            </div>
          ) : (
            <div className="space-y-4">
              {messages.map((msg: any) => {
                const isSystem = msg.messageType === "system";
                const isMe = msg.senderModel === "OrganizationProfile";
