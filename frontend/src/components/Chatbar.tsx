...
import zinAvatar from "@/assets/img/zin-avatar.png"; // <-- 1. ĐÃ THÊM IMPORT
...
export function ChatBar({
  ...
  // HÀM XỬ LÝ SCROLL TRÊN DI ĐỘNG KHI FOCUS
  const handleTextAreaFocus = () => {
    // ... (logic handleTextAreaFocus giữ nguyên) ...
    setIsExpanded(true);
  ...
  return (
    ...
    >
      {/* VỎ BỌC GRADIENT */}
      <div
        className="bg-gradient-to-r from-blue-400 to-cyan-500 rounded-2xl md:rounded-3xl p-[1.5px] 
          ...
          >
            ...
            {messages.length === 0 && (
              <div className="flex gap-2 md:gap-3 mb-3 md:mb-4">
                {/* ================================================== */}
                {/* 2. ĐÃ THAY THẾ AVATAR BOT TẠI ĐÂY */}
                {/* ================================================== */}
            ...
            {messages.length > 0 && (
              <div className="mb-4">
                {/*
                  LƯU Ý: Avatar của bot KHI CHAT nằm trong component này.
                  Hãy gửi file ChatMessages.tsx để tôi thay đổi luôn nhé!
                */}
          ...
          <div className="px-3 md:px-6 pb-3 md:pb-6 pt-2 md:pt-3">
            <div className="bg-slate-50/80 backdrop-blur-sm rounded-xl md:rounded-2xl border border-slate-200/80 overflow-hidden hover:border-indigo-300 transition-colors focus-within:border-indigo-500 focus-within:ring-2 md:focus-within:ring-4 focus-within:ring-indigo-100">
              <textarea
                ...
                onFocus={handleTextAreaFocus} // SỬ DỤNG HÀM MỚI
